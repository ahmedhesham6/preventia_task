...
import { MenuConfig } from '../../../core/_config/system-admin/menu.config';
import { PageConfig } from '../../../core/_config/system-admin/page.config';
// User permissions
...
export class BaseComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    const layoutSubdscription = this.layoutConfigService.onConfigUpdated$.subscribe(
      layoutConfig => {
